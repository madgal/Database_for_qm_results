def generate_CuspDir(outerDir,fileroot,multiDet):
	'''
	#!/usr/bin/env python 
	# -*- coding : utf-8 -*- 
	...
	os.system("cp misc/Cusp.xml " +thisDir)
	...
	os.system("cp misc/"+fileName+" "+thisDir+"/modify_wfs_4_Cusp.py")
	
	os.system("cp misc/cusp.sh " +thisDir + "/cusp.sh") 
